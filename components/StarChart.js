...
import Svg, { Circle } from 'react-native-svg';
  ...
  const celestialBodies = [
    { id: 1, name: 'Mars', x: 150, y: 250, color: 'orange', size: 6, distance: 225, description: 'The Red Planet, known for its iron-rich dust and potential for past life.' },
    { id: 2, name: 'Jupiter', x: 300, y: 200, color: 'orange', size: 4, distance: 778, description: 'The largest planet in our solar system, famous for its Great Red Spot.' },
    { id: 3, name: 'Venus', x: 100, y: 300, color: 'orange', size: 7, distance: 108, description: 'The hottest planet, covered in thick clouds of sulfuric acid.' },
    ...
    { id: 13, name: 'Saturn', x: 350, y: 180, color: 'orange', size: 3, description: 'The ringed planet, famous for its extensive and beautiful ring system.' },
    { id: 14, name: 'Uranus', x: 400, y: 150, color: 'orange', size: 2, description: 'An ice giant that rotates on its side, giving it unique seasons.' },
    { id: 15, name: 'Neptune', x: 450, y: 120, color: 'orange', size: 2, description: 'The farthest known planet, known for its deep blue color and strong winds.' },
    ...
    { id: 23, name: 'Moon', x: 200, y: 200, color: 'gray', size: 10, description: 'Earth’s only natural satellite, known for its influence on tides and stunning phases.' },
  ];
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal visible={!!selectedBody} transparent animationType="slide">
        <TouchableWithoutFeedback onPress={() => setSelectedBody(null)}>
          <View style={styles.modalContainer}>
            <TouchableWithoutFeedback>
              <View style={styles.modalContent}>
                <Text style={styles.starName}>{selectedBody?.name}</Text>
                <Text style={styles.starDesc}>{selectedBody?.description}</Text>
...
const styles = StyleSheet.create({
  ...
  modalContainer: { flex: 1, justifyContent: 'flex-end', paddingBottom: '30%' },
  modalContent: { backgroundColor: 'white', padding: 20, borderRadius: 10, marginHorizontal: 10, textAlign: 'center',},
  starName: { fontSize: 20, fontFamily: 'VarelaRound', fontWeight: 'bold', textAlign: 'center', marginBottom: 10 },
  starDesc: { fontSize: 16, fontFamily: 'VarelaRound', textAlign: 'center', marginBottom: 10 },
  closeButton: { marginTop: 10, color: 'blue', textAlign: 'center', fontFamily: 'VarelaRound' },
});
